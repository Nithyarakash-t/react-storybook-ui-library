 ...
 * Transition
 * Is state required ?
 * To control siblings from here / from parent ?
 * Pass HTML
 */
...
export const Collapse = (
    { 
        dataParentid=null, ariaExpanded=true, ariaControls='region1', 
        ...
        <>
            <div className='c-abaccordion'>
                <button type='button' className='c-collapse' 
                    ...
                    aria-controls={ariaControls} onClick={btnClick ? btnClick : null}> {/* onClick={toggle}*/}
                ...
                <div ref={elref} id={ariaControls} className={ `-collapse ${ariaExpanded===true ? OPEN_CLASS : ''}` }   
                {...(dataParentid && {'data-parentid': dataParentid})}
                // style={ ariaExpanded ? { height: `${elref.current.scrollHeight}px` } : { height: "0px" } }
                >
